...
SECRET_KEY = 'django-insecure-yl@9pt8=z0(m3xuk#8s!-3yz$ovmb0m077h^p429*_@*t!hvc8'
...
# MODEL_PATH = os.path.join(BASE_DIR, "ml_models", "best_model.pt")
